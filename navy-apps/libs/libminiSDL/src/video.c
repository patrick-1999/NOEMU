...
/* This function copies the pixels in the region specified by the x, y, w, and h parameters to the screen. 
  (x, y) is the upper left corner of the region, and (w, h) is the width and height of the region, respectively. 
  If the w and h parameters are both 0, the entire surface is copied to the screen. */
